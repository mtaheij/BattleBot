...
@hook.command("bpwiki", "wiki", "w", "search")
def bpwiki(text):
    """bpwiki <phrase> - gets the first paragraph of the BattleWiki article on <phrase>"""
    ...
    try:
        ...
        return "Error fetching BattleWiki page: {}".format(e)
